...
<body>
    ...
    /*
        ...
        */
        $arr2 = array (
            array("Name"=>"Will Byers","Age"=>"22","Aliases" => "Will the wise","Status" => "Alive"),
            array("Name"=>"Mike Wheeler","Age"=>"12","Aliases" => "Dugeon Master","Status" => "Alive"),
            array("Name"=>"Jim Hooper","Age"=>"43","Aliases" => "Chief Hopper","Status" => "Diceased"),
            array("Name"=>"Eleven","Age"=>"12","Aliases" => "El","Status" => "Alive")
          );

        for ($row = 0; $row < 4; $row++) {
            echo "<p><b>[0] => Array </b></p>";
            echo "<ul>";
              echo "<li>[Name] =>".$arr2[$row]["Name"]."</li>";
              echo "<li>[Age] =>".$arr2[$row]["Age"]."</li>";
              echo "<li>[Aliases] =>".$arr2[$row]["Aliases"]."</li>";
              echo "<li>[Status] =>".$arr2[$row]["Status"]."</li>";
            echo "</ul>";
        }
    ?>
</body>
